 ...
 *    $Id: mb_zgrid.c 1770 2009-10-19 17:16:39Z caress $
 *
...
//#include "../constants.h" //for MIN_INT SJZ
#ifndef MIN_INT//Denson says this is platform specific be careful
...
/*----------------------------------------------------------------------- */
/*
I know there are GOTO's in this, it's not worth recoding to remove them.  
The GOTO's were left in here, that does not mean ANYONE should use them,
ever, under any coding practice.  I do not condone their use at any time.
Just for reference, GOTO is NOT good!!! I didn't put them in here, and they 
make the code difficult to follow.  Again, GOTO's are typically BAD!!!!
-Kevin M. Duvieilh
*/
		...
		float *cay, int *nrng)
{
    ...
    float dzrms8, z00, dz, ze, hrange, zn, zs, zw, zrange, 
            dzmaxf, convtest, convtestlast=MIN_INT,// 7/7/15 initialize before use SJZ
