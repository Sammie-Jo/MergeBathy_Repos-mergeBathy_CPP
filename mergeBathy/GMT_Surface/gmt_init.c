/*--------------------------------------------------------------------
 *	$Id: gmt_init.c,v 1.2 2008/08/13 15:55:50 tgray Exp $
 *
...
/* TG	GMT_get_time_language (gmtdefs.time_language); */
...
/*	if (gmtdefs.encoding.name) free (gmtdefs.encoding.name); Segmentation Fault*/
	if (GMT_n_colors) {
...
#endif
	return (GMT_NOERROR);
/*MR	if (!gmtdefs.history) return (GMT_NOERROR);*/	/* .gmtcommands4 mechanism has been disabled */
